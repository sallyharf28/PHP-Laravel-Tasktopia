	...
	<div class="col-lg-12">
		<div class="card card-outline card-primary">
			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						...
						<input type="text" class="form-control form-control-sm" name="name" value="{{ isset($name) ? $name : ''  }}">
					</div>
				</div>
				<div class="col-md-6">
					<div class="form-group">
			...
			<div class="row">
				...
				<input type="date" class="form-control form-control-sm" autocomplete="off" name="start_date" value="{{ isset($start_date) ? date("Y-m-d",strtotime($start_date)) : '' }}">
				</div>
			</div>
			<div class="col-md-6">
				<div class="form-group">
				<label for="" class="control-label">End Date</label>
				<input type="date" class="form-control form-control-sm" autocomplete="off" name="end_date" value="{{ isset($end_date) ? date("Y-m-d",strtotime($end_date)) : '' }}">
				</div>
			</div>
			</div>
			<div class="row">
				@if(auth()->user()->type == 1 )
					<div class="col-md-6">
						<div class="form-group">
							<label for="" class="control-label">Team Member</label>
				...
				@else
					<input type="hidden" name="manager_id" value="{{ session('login_id') }}">
				@endif
			<div class="row">
				<div class="col-md-10">
					<div class="form-group">
